...
public class BuildDetailsHibernateRepository extends AbstractHibernateRepository implements BuildDetailsRepository {
  ...
  public BuildNode getBuildNodeByUrl(final String url) {
    ...
    try {
      ...
      final List<BuildNode> nodes = getHibernateTemplate().findByCriteria(criteria);
  ...
  public void saveBuildDetailsList(final List<BuildDetails> details) {
    ...
    try {
      ...
      LOGGER.log(Level.SEVERE, "An error occurred while saving the build details.", e);
    }
  }
  ...
  @Override
  public List<String> getProjectNames(final String masterHostName, final Date fromDate, final Date toDate) {
  ...
  @Override
  public List<BuildDetails> getBuildDetails(final String masterHostName, final Date fromDate, final Date toDate) {
